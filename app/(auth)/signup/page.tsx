      ...
      <div className="w-full max-w-mobile">
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl text-sm font-semibold active:scale-95"
          ...
          <p className="text-center text-sm" style={{ color: "rgba(255,255,255,0.5)" }}>
            {t.auth.haveAccount}{" "}
            <Link href="/login" className="font-semibold" style={{ color: "#007AFF" }}>
              {t.auth.signIn}
            </Link>
          </p>
        </div>
